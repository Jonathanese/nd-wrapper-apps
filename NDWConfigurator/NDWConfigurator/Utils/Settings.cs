...
namespace NDWConfigurator
{
    public class SettingsFile : ISettings
    {
        ...
        public SettingsFile(string configpath, string relativepath)
        {
            _path = configpath + relativepath;
        }
        ...
        public string ReadSetDefault(string section, string key, string defaultvalue)
        {
