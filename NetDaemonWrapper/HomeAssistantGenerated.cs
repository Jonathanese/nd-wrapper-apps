//------------------------------------------------------------------------------
// <auto-generated>
// Generated using NetDaemon CodeGenerator nd-codegen v22.52.0.0
//   At: 2023-01-02T01:26:36.2344066-05:00
//
...
public partial class AutomationEntities
{
    ...
    ///<summary>Leak Notification</summary>
    public AutomationEntity LeakNotification => new(_haContext, "automation.leak_notification");
    ...
    ///<summary>Door/Window Left Open Notification</summary>
    public AutomationEntity OpenNotification => new(_haContext, "automation.open_notification");
    ...
    ///<summary>Reset Magic Packet</summary>
    public AutomationEntity ResetMagicPacket => new(_haContext, "automation.reset_magic_packet");
    ///<summary>Turn Heat Off</summary>
    public AutomationEntity TurnHeatOff => new(_haContext, "automation.turn_heat_off");
    ///<summary>Turn Off Backup DNS</summary>
    public AutomationEntity TurnOffBackupDns => new(_haContext, "automation.turn_off_backup_dns");
    ...
    ///<summary>Turn on backup DNS</summary>
    public AutomationEntity TurnOnBackupDns => new(_haContext, "automation.turn_on_backup_dns");
...
public partial class BinarySensorEntities
{
    ...
    ///<summary>Basement Window North</summary>
    public BinarySensorEntity BasementWindowNorth => new(_haContext, "binary_sensor.basement_window_north");
    ///<summary>Basement Window West</summary>
    public BinarySensorEntity BasementWindowWest => new(_haContext, "binary_sensor.basement_window_west");
    ///<summary>Breakfast Window Center</summary>
    public BinarySensorEntity BreakfastWindowCenter => new(_haContext, "binary_sensor.breakfast_window_center");
    ///<summary>Sensor</summary>
    public BinarySensorEntity BreakfastWindowLeft => new(_haContext, "binary_sensor.breakfast_window_left");
    ///<summary>Breakfast_Window_Right</summary>
    public BinarySensorEntity BreakfastWindowRight => new(_haContext, "binary_sensor.breakfast_window_right");
    ...
    ///<summary>Front Window 1</summary>
    public BinarySensorEntity FrontWindow1 => new(_haContext, "binary_sensor.front_window_1");
    ///<summary>Front Window 2</summary>
    public BinarySensorEntity FrontWindow2 => new(_haContext, "binary_sensor.front_window_2");
    ...
    ///<summary>Living Room Window Center</summary>
    public BinarySensorEntity LivingRoomWindowCenter => new(_haContext, "binary_sensor.living_room_window_center");
    ///<summary>Living Room Window Left</summary>
    public BinarySensorEntity LivingRoomWindowLeft => new(_haContext, "binary_sensor.living_room_window_left");
    ///<summary>Living Room Window Right</summary>
    public BinarySensorEntity LivingRoomWindowRight => new(_haContext, "binary_sensor.living_room_window_right");
    ///<summary>Mudroom Door</summary>
    public BinarySensorEntity MudroomDoor => new(_haContext, "binary_sensor.mudroom_door");
    ///<summary>North Window Leak Sensor</summary>
    public BinarySensorEntity NorthWindowLeak => new(_haContext, "binary_sensor.north_window_leak");
    ...
    ///<summary>Side Window 1</summary>
    public BinarySensorEntity SideWindow1 => new(_haContext, "binary_sensor.side_window_1");
    ///<summary>Side Window 2</summary>
    public BinarySensorEntity SideWindow2 => new(_haContext, "binary_sensor.side_window_2");
    ///<summary>Sink Window</summary>
    public BinarySensorEntity SinkWindow => new(_haContext, "binary_sensor.sink_window");
    ...
    ///<summary>Sump Leak</summary>
    public BinarySensorEntity SumpLeak => new(_haContext, "binary_sensor.sump_leak");
    ///<summary>Updater</summary>
    public BinarySensorEntity Updater => new(_haContext, "binary_sensor.updater");
    ///<summary>West Window Leak</summary>
    public BinarySensorEntity WestWindowLeak => new(_haContext, "binary_sensor.west_window_leak");
}
...
public partial class ButtonEntities
{
    ...
    ///<summary>Bedroom TH Identify</summary>
    public ButtonEntity BedroomThIdentify => new(_haContext, "button.bedroom_th_identify");
    ...
    ///<summary>Guest Bedroom TH Identify</summary>
    public ButtonEntity GuestBedroomThIdentify => new(_haContext, "button.guest_bedroom_th_identify");
    ...
    ///<summary>Office TH Identify</summary>
    public ButtonEntity OfficeThIdentify => new(_haContext, "button.office_th_identify");
    ...
    ///<summary>Studio TH Identify</summary>
    public ButtonEntity StudioThIdentify => new(_haContext, "button.studio_th_identify");
    ///<summary>Sump Leak Identify</summary>
    public ButtonEntity SumpLeakIdentify => new(_haContext, "button.sump_leak_identify");
    ///<summary>West Window Leak Identify</summary>
    public ButtonEntity WestWindowLeakIdentify => new(_haContext, "button.west_window_leak_identify");
}
...
public partial class FanEntities
{
    ...
    ///<summary>Caséta® Wireless Fan Speed Control</summary>
    public FanEntity CasetaRWirelessFanSpeedControl => new(_haContext, "fan.caseta_r_wireless_fan_speed_control");
    ///<summary>Caséta® Wireless Fan Speed Control</summary>
    public FanEntity CasetaRWirelessFanSpeedControl2 => new(_haContext, "fan.caseta_r_wireless_fan_speed_control_2");
...
public partial class InputDatetimeEntities
{
    ...
    ///<summary>Morning Time</summary>
    public InputDatetimeEntity MorningTime => new(_haContext, "input_datetime.morning_time");
}
...
public partial class LightEntities
{
    ...
    ///<summary>End Table 1</summary>
    public LightEntity EndTable1 => new(_haContext, "light.end_table_1");
    ///<summary>End Table 2</summary>
    public LightEntity EndTable2 => new(_haContext, "light.end_table_2");
    ///<summary>End Table 3</summary>
    public LightEntity EndTable3 => new(_haContext, "light.end_table_3");
    ...
    ///<summary>Nightstand L</summary>
    public LightEntity NightstandL => new(_haContext, "light.nightstand_l");
...
public partial class ScriptEntities
{
    ...
    ///<summary>Crash Test</summary>
    public ScriptEntity CrashTest => new(_haContext, "script.crash_test");
...
public partial class SensorEntities
{
    ...
    ///<summary>Bedroom TH Humidity</summary>
    public NumericSensorEntity BedroomH => new(_haContext, "sensor.bedroom_h");
    ///<summary>Bedroom TH Pressure</summary>
    public NumericSensorEntity BedroomP => new(_haContext, "sensor.bedroom_p");
    ///<summary>Bedroom TH Temperature</summary>
    public NumericSensorEntity BedroomT => new(_haContext, "sensor.bedroom_t");
    ///<summary>Bedroom TH Battery</summary>
    public NumericSensorEntity BedroomThBattery => new(_haContext, "sensor.bedroom_th_battery");
    ...
    ///<summary>Guest Bedroom TH Humidity</summary>
    public NumericSensorEntity GuestBedroomH => new(_haContext, "sensor.guest_bedroom_h");
    ///<summary>Guest Bedroom TH Pressure</summary>
    public NumericSensorEntity GuestBedroomP => new(_haContext, "sensor.guest_bedroom_p");
    ///<summary>Guest Bedroom TH Temperature</summary>
    public NumericSensorEntity GuestBedroomT => new(_haContext, "sensor.guest_bedroom_t");
    ///<summary>Guest Bedroom TH Battery</summary>
    public NumericSensorEntity GuestBedroomThBattery => new(_haContext, "sensor.guest_bedroom_th_battery");
    ...
    public NumericSensorEntity LivingRoomH => new(_haContext, "sensor.living_room_h");
    ...
    public NumericSensorEntity LivingRoomT => new(_haContext, "sensor.living_room_t");
    ///<summary>Living Room TH Battery</summary>
    public NumericSensorEntity LivingRoomThBattery => new(_haContext, "sensor.living_room_th_battery");
    ///<summary>CPU</summary>
    public NumericSensorEntity Load15mPct => new(_haContext, "sensor.load_15m_pct");
    ///<summary>North Window Leak Device temperature</summary>
    ...
    ///<summary>North Window Leak Battery</summary>
    public NumericSensorEntity NorthWindowLeakBattery => new(_haContext, "sensor.north_window_leak_battery");
    ///<summary>Office TH Humidity</summary>
    public NumericSensorEntity OfficeH => new(_haContext, "sensor.office_h");
    ///<summary>Office TH Pressure</summary>
    public NumericSensorEntity OfficeP => new(_haContext, "sensor.office_p");
    ///<summary>Office TH Temperature</summary>
    public NumericSensorEntity OfficeT => new(_haContext, "sensor.office_t");
    ///<summary>Office TH Battery</summary>
    public NumericSensorEntity OfficeThBattery => new(_haContext, "sensor.office_th_battery");
    ...
    ///<summary>Studio TH Humidity</summary>
    public NumericSensorEntity StudioH => new(_haContext, "sensor.studio_h");
    ///<summary>Studio TH Pressure</summary>
    public NumericSensorEntity StudioP => new(_haContext, "sensor.studio_p");
    ///<summary>Studio TH Temperature</summary>
    public NumericSensorEntity StudioT => new(_haContext, "sensor.studio_t");
    ///<summary>Studio TH Battery</summary>
    public NumericSensorEntity StudioThBattery => new(_haContext, "sensor.studio_th_battery");
    ///<summary>Sump Leak Battery</summary>
    public NumericSensorEntity SumpLeakBattery => new(_haContext, "sensor.sump_leak_battery");
    ///<summary>Sump Leak Device temperature</summary>
    public NumericSensorEntity SumpLeakT => new(_haContext, "sensor.sump_leak_t");
    ///<summary>Breakfast Center</summary>
    ...
    ///<summary>West Window Leak Battery</summary>
    public NumericSensorEntity WestWindowLeakBattery => new(_haContext, "sensor.west_window_leak_battery");
    ///<summary>West Window Leak Device temperature</summary>
    public NumericSensorEntity WestWindowLeakT => new(_haContext, "sensor.west_window_leak_t");
...
public partial class SwitchEntities
{
    ...
    ///<summary>Desktop Wake</summary>
    public SwitchEntity DesktopWake => new(_haContext, "switch.desktop_wake");
...
public partial record BinarySensorAttributes
{
    ...
    public object? ChargingState { get; init; }

    [JsonPropertyName("conn_charge_cable")]
    public object? ConnChargeCable { get; init; }

    [JsonPropertyName("fast_charger_present")]
    public object? FastChargerPresent { get; init; }

    [JsonPropertyName("fast_charger_brand")]
    public object? FastChargerBrand { get; init; }

    [JsonPropertyName("fast_charger_type")]
    public object? FastChargerType { get; init; }
    ...
    public object? Scheduledchargingtime { get; init; }

    [JsonPropertyName("Departure time")]
    public object? Departuretime { get; init; }

    [JsonPropertyName("Preconditioning enabled")]
    public object? Preconditioningenabled { get; init; }

    [JsonPropertyName("Preconditioning weekdays only")]
    public object? Preconditioningweekdaysonly { get; init; }

    [JsonPropertyName("Off peak charging enabled")]
    public object? Offpeakchargingenabled { get; init; }

    [JsonPropertyName("Off peak charging weekdays only")]
    public object? Offpeakchargingweekdaysonly { get; init; }

    [JsonPropertyName("End off peak time")]
    public object? Endoffpeaktime { get; init; }
...
public partial record DeviceTrackerAttributes
{
    ...
    public object? Heading { get; init; }
...
public partial record NotifyMobileAppSmG973uParameters
{
    ///<summary>Message body of the notification. eg: The garage door has been open for 10 minutes.</summary>
    [JsonPropertyName("message")]
    public string? Message { get; init; }
...
public partial class ScriptServices
{
    ...
    {
        _haContext.CallService("script", "crash_test", null);
    }
