...
namespace NetDaemonWrapper.Scene
{
    ...
    {
        public Scenes(IHaContext _haContext)
        {
            Scene NightLight = new Scene("night_light", (Lights) =>
            {
            ...
            Scene NormalLights = new Scene("normal_lights", (Lights) =>
            {
                foreach (MLight l in Lights)
                {
            ...
            Scene RandomColors = new Scene("random_colors", 10, (Lights) =>
            {
                Random r = new Random();
            ...
            Scene VacationLights = new Scene("vacation_lights", 60, (Lights) =>
            {
                Random r = new Random();
                foreach (MLight l in Lights)
                {
